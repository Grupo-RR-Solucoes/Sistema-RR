...
const styles: Record<string, CSSProperties> = {
  ...
  bar: {
    ...
    zIndex: 40,
    background: "#fff",
    borderTop: "1px solid var(--rr-line-strong, #d6dbe4)",
    boxShadow: "0 -10px 30px rgba(15, 31, 74, 0.10)",
  ...
  warningBox: {
    padding: "8px 12px",
    borderRadius: 8,
    background: "rgba(214,161,63,0.12)",
  ...
  preview: {
    ...
    border: "1px solid rgba(13,77,227,0.15)",
    fontSize: 12,
    color: "var(--rr-ink, #0F1F4A)",
  },
  previewLabel: {
