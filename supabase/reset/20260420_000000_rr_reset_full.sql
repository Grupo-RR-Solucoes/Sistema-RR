-- ATENCAO:
-- Este script apaga toda a schema public do projeto atual no Supabase
-- e recria a estrutura base do Sistema RR do zero.
-- Use somente se tiver certeza de que quer descartar os dados atuais.
